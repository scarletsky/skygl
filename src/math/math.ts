...
const INV_LOG = 1 / Math.log(2);
const intToBytes = intToBytes32;
const bytesToInt = bytesToInt32;
...
function bytesToInt24(r: number | number[], g?: number, b?: number): number {
    if (Array.isArray(r)) {
        b = r[2];
        g = r[1];
        r = r[0];
...
function bytesToInt32(r: number | number[], g?: number, b?: number, a?: number): number {
    if (Array.isArray(r)) {
        a = r[3];
        b = r[2];
        g = r[1];
