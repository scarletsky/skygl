...
export default class Quat {
    ...
    public slerp(lhs: Quat, rhs: Quat, alpha: number) {
    ...
    public transformVector(vec: Vec3, res?: Vec3) {
        if (res === undefined) {
            res = new Vec3();
        }
